...
echo "
Rolling two six sided dice and
$(( RANDOM % 6 + 1)), $(( RANDOM % 6 + 1 ))  was rolled
"
echo "
Rolling five six sided dice and
$(( RANDOM % 6 + 1)), $(( RANDOM % 6 + 1 )), $(( RANDOM % 6 + 1 )), $(( RANDOM % 6 + 1 )), $(( RANDOM % 6 + 1 ))  was rolled
"
echo "
Rolling a one twenty sided dice and
